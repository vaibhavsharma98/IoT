...
const char* ssid = "vaibhavwifi"; //replace with your own wifi ssid const 
char* password = "vs1010100"; //replace with your own //wifi ssid password const 
char* host = "innovativeupshot.in";
void setup() { 
  Serial.begin(115200); 
...
String url = "http://innovativeupshot.in/harshit/hardwareToServerGET.php?deviceid=Z5A3WBIHLlijbfgxkTDc&status=1";
/* url += "?param1=";
url += param1;
url += "?param2=";
url += param2;
